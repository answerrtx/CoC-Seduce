...
JSON_DIR        = ROOT / "scenes" / "json_qwen"
CSV_DIR         = ROOT / "scenes" / "csv_qwen"

# Model override: set to None to use the value from llm_config.json providers.qwen.dialogue
