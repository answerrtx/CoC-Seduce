...
JSON_DIR        = ROOT / "scenes" / "json_claude"
CSV_DIR         = ROOT / "scenes" / "csv_claude"

# Model override: set to None to use the value from llm_config.json providers.claude.dialogue
...
def load_configs():
    ...
    claude_cfg = llm_cfg["providers"]["claude"]
    api_key = claude_cfg["api_key"]
    model   = MODEL_OVERRIDE or claude_cfg["dialogue"]
