...
JSON_DIR        = ROOT / "scenes" / "json_gemini"
CSV_DIR         = ROOT / "scenes" / "csv_gemini"

# Model override: set to None to use the value from llm_config.json providers.gemini.dialogue
...
RERUN_ONLY: list[str] = [
    "CMB_Brawl_Wilderness",
    "CMB_Handgun_Ancient_China",
    "CMB_Dodge_Ancient_China",
    "PHY_Climb_2020s_Urban",
    "PHY_Jump_2020s_Urban",
    "INV_Spot_Hidden_2020s_Urban",
    "INV_Library_Use_1920s_Urban",
    "INV_Library_Use_2020s_Urban",
    "INV_Library_Use_Ancient_China",
    "INV_Track_2020s_Urban",
]
...
def load_configs():
    ...
    gemini_cfg = llm_cfg["providers"]["gemini"]
    api_key = gemini_cfg["api_key"]
    model   = MODEL_OVERRIDE or gemini_cfg["dialogue"]

    categories      = scene_cfg["categories"]
    target_settings = scene_cfg["target_settings"]
